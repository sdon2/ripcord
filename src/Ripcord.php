...
class Ripcord
{
	 ...
	 * It will throw a 'Variable is not of type datetime' Ripcord_InvalidArgumentException (code -6)
	...
	public static function timestamp($datetime) 
	{
		if (xmlrpc_get_type($datetime)=='datetime') 
		{
			...
			throw new Ripcord_InvalidArgumentException('Variable is not of type datetime', -6);
		}
	}
	 ...
	 * It will throw a 'Variable is not of type base64' Ripcord_InvalidArgumentException (code -7)
	 * if the given argument is not of the correct type.
	 * @param object $base64
	 * @return string
	 */
	public static function binary($base64) 
	{
		if (xmlrpc_get_type($base64)=='base64')
		{
			...
			throw new Ripcord_InvalidArgumentException('Variable is not of type base64', -7);
		}
	}
	...
	{
		throw new Ripcord_BadMethodCallException("Load is obselte");
	}
